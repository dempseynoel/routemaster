...
<b>Background image</b> - if you're viewing the site on a computer or an Android phone this shouldn't apply, but if you're on an iPhone you're likely missing a background image at the top of the page when it's loaded. As far as I can tell it's an issue specific to iPhone and seems like a fairly common issue on Stackoverflow. This is clearly not how I wanted the site to appear on iPhones and so I'll be investigating how to resolve the problem.
